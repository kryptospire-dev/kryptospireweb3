      ...
      <section className="section-padding bg-gradient-to-br from-background via-background to-surface">
        <div className="container-custom">
          ...
          >
            ...
            >
              Ready to take your Web3 project to the next level? We'd love to
              hear about your vision and discuss how we can help you achieve
              your goals.
            </motion.p>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              ...
              >
                ...
                <motion.div
                  ...
                  custom={3}
                >
                  <Label htmlFor="project" className="text-text-primary">
                    Project Name
                  </Label>
                  <Input
                    id="project"
            ...
            >
              <div>
                ...
                >
                  We're here to help you navigate the Web3 landscape and achieve
                  your growth objectives. Reach out through any of these
                  channels.
                </motion.p>
              </div>
              ...
              >
                {CONTACT_INFO.map((info, index) => {
                  ...
                  return (
                    ...
                    >
                      <motion.div
                        className="bg-surface border border-border rounded-lg p-6 card-glow hover:border-gradient-start/30 
               ...
               text-center sm:text-left flex flex-col items-center sm:items-start"
                      ...
                      >
                        ...
                        <motion.div
                          className="absolute inset-0 bg-gradient-to-br from-gradient-start/3 to-gradient-end/3 
                 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                        ...
                        <div className="relative z-10 flex flex-col items-center sm:items-start">
                          <div className="flex flex-col sm:flex-row items-center sm:items-start mb-4">
                            <motion.div
                              className="w-10 h-10 bg-gradient-primary rounded-lg flex items-center justify-center mb-2 sm:mb-0 sm:mr-4"
