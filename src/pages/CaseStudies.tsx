        ...
        <div className="container-custom">
          ...
          >
            <h1 className="text-5xl lg:text-6xl font-bold mb-6">
              Real <span className="gradient-text">results</span> for real
              projects
            </h1>
            <p className="text-xl text-text-secondary leading-relaxed mb-8">
              Discover how we've helped Web3 projects achieve extraordinary
              growth, build thriving communities, and create lasting impact in
            ...
            >
              ...
              >
                ...
                <span>$1.1B+ Market Cap Driven</span>
              </motion.div>
              <motion.div
                className="flex items-center"
                whileHover={{ scale: 1.05 }}
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto">
              Our track record speaks for itself. Here's what we've achieved for
              our clients.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                desc: "Successful Web3 launches",
              },
              {
                number: "$1.1B+",
                label: "Market Cap Driven",
                desc: "Total value created",
              },
              {
                number: "5M+",
                label: "Community Members",
                desc: "Engaged community built",
              },
              {
                number: "450%",
                label: "Average Growth",
                desc: "TVL/Volume increase",
              },
            ].map((stat, index) => (
              <motion.div
                key={index}
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-xl text-text-secondary mb-8">
              Join the 150+ Web3 projects that have achieved extraordinary
              results with KryptoSpire.
            </p>
            <motion.div
